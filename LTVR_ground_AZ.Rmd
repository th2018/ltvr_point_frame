...
```{r}
rhem_lookup<-data.frame( field_species =c("artrw8","elel5","gl","m","phlo2",   "pose", "s","sl", "ssdw", "drve2", "ascu5", "r", "sdw"),RHEM=c("Shrubs","Bunch Grass","Litter Cover %","Biological Crusts Cover","Forbs/Annuals", "Bunch Grass", "Bare", "Shrubs" , "Shrubs", "Forbs/Annuals", "Forbs/Annuals", "rock", "Shrubs"))
rhem_lookup
```
