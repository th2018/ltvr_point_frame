...
lookup<-data.frame(field_species=c("sdw","ssdw","s","artrw8","drve2","gl","pose","w","pssp6","r","sl","m","fl","phlo2", "ascu5", "elel5"),description=c("shrub dead wood; >.25 inch or .5cm","standing shrub dead wood; >.25 inch or .5cm","soil; <.25 inch or .5cm","Wyoming big sagebrush","drve2","graminoid litter","pose","wood > .25 inch or .5cm","pssp6","rock; >.25 inch or .5cm","shrub dead wood; <.25 inch or .5cm","moss","forb litter","Phlox longifolia", "Astragalus cusickii", "Elymus elymoides"))
lookup
...
```{r}
rhem_lookup<-data.frame( field_species =c("artrw8","elel5","gl","m","phlo2",   "pose", "s","sl", "ssdw"),RHEM=c("Shrubs","Bunch Grass","Litter Cover %","Biological Crusts Cover","Forbs/Annuals", "Bunch Grass", "Bare", "Shrubs" , "Shrubs"))
rhem_lookup
```
...
```{r}
0.12105263+0.03684211+0.02105263
0.05789474+0.32105263
0.02631579
1-0.25-(0.02631579)
```
