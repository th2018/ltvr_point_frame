...
#wbs1_all_2019_plot31<-wbs3_all[wbs3_all$Date>=as.POSIXct("01/01/2019",format="%m/%d/%Y") & wbs3_all$Date<as.POSIXct("01/01/2021",format="%m/%d/%Y") & wbs3_all$plot==31,]
...
lookup<-data.frame(field_species=c("sdw","ssdw","s","artrw8","drve2","gl","pose","w","pssp6","r","sl","m","fl","phlo2", "ascu5", "elel5", "andi2","brte"),description=c("shrub dead wood; >.25 inch or .5cm","standing shrub dead wood; >.25 inch or .5cm","soil; <.25 inch or .5cm","Wyoming big sagebrush","Draba verna L.","graminoid litter","pose","wood > .25 inch or .5cm","pssp6","rock; >.25 inch or .5cm","shrub dead wood; <.25 inch or .5cm","moss","forb litter","Phlox longifolia", "Astragalus cusickii", "Elymus elymoides","Antennaria dimorpha", "Bromus tectorum"))
lookup
...
```{r}
rhem_lookup<-data.frame( field_species =c("artrw8","elel5","gl","m","phlo2",   "pose", "s","sl", "ssdw", "drve2", "ascu5", "r", "sdw", "andi2", "brte"),RHEM=c("Shrubs","Bunch Grass","Litter Cover %","Biological Crusts Cover","Forbs/Annuals", "Bunch Grass", "Bare", "Shrubs" , "Shrubs", "Forbs/Annuals", "Forbs/Annuals", "rock", "Shrubs", "Forbs/Annuals", "Forbs/Annuals"))
rhem_lookup
```
